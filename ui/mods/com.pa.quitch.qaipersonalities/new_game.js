...
function qaipersonalities() {
  ...
  var newPersonalities = {
    ...
    "AIP-Absurd Legonis Machina": {
      display_name: "!LOC:Absurd Legonis Machina",
    ...
    "AIP-Absurd Foundation": {
      display_name: "!LOC:Absurd Foundation",
      fabber_to_factory_ratio_basic: 1.5,
      min_basic_fabbers: 1,
      max_basic_fabbers: 15,
      max_advanced_fabbers: 50,
    ...
    "AIP-Absurd Synchronous": {
      display_name: "!LOC:Absurd Synchronous",
      fabber_to_factory_ratio_basic: 1.5,
      min_basic_fabbers: 1,
      max_basic_fabbers: 15,
      max_advanced_fabbers: 50,
    ...
    "AIP-Absurd Revenants": {
      display_name: "!LOC:Absurd Revenants",
      fabber_to_factory_ratio_basic: 1.5,
      min_basic_fabbers: 1,
      max_basic_fabbers: 15,
      max_advanced_fabbers: 50,
